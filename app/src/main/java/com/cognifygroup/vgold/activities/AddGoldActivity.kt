        ...
        client.newCall(request).enqueue(object : okhttp3.Callback {
            ...
            override fun onResponse(call: Call, response: okhttp3.Response) {
                ...
                if (!response.isSuccessful) {
                    ...
                    runOnUiThread {
                        if (status == "200") {
                            var Gold_purchase_rate_with_gst =
                                json.get("Gold_purchase_rate_with_gst").toString()
                            txtGoldRate!!.text = "₹ $Gold_purchase_rate_with_gst/GM"
                            todayGoldRateWithGst = Gold_purchase_rate_with_gst
                        } else {
                            PrintUtil.showToast(
                                this@AddGoldActivity,
